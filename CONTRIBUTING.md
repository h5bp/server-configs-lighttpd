# Contributing to lighttpd Server Configs
...
The [issue tracker](https://github.com/h5bp/server-configs-lighttpd/issues) is
...
your environment? What steps will reproduce the issue? What version of lighttpd
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/server-configs-lighttpd.git
   # Navigate to the newly cloned directory
   cd server-configs-lighttpd
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/h5bp/server-configs-lighttpd
   ```
